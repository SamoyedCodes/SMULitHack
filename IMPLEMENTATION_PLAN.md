...
Each phase has a separate acceptance boundary. Phases 1–6 are integrated, with ingestion, extraction, deadlines, distribution conflicts and handoff enabled. Phase 7 evaluation/demo remains unimplemented. See `docs/PHASE_4_6_INTEGRATION.md` for combined verification and limitations.
