...
const doc: ApiDocument = { id:'a', filename:'a.pdf', title:'a', sha256:'h', mode:'live', status:'needs_review', stage:'Review required', error:null, page_count:2, pages_read:2, pages_analyzed:2, has_ocr:true, pagination:'original', parties:['Acme'], findings:[finding,{...finding,id:'pay2',value:'Late fee: S$20'}], rules:[], provisions:[], reviews:[], issues:[], warnings:[], created_at:'2026-09-05', model:'fake', version:'test' }
...
it('shows data transfer and blocks another extraction while quota is waiting', () => {
  ...
  expect(html).toContain('page text to Gemini')
