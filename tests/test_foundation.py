...
def test_health_no_key_tools_optional_and_empty_portfolio(tmp_path):
    ...
    with TestClient(app) as client:
        ...
        assert caps.pop('extraction') is True and not any(caps.values())
...
@pytest.mark.parametrize('method,path', [('POST','/api/batches'),('POST','/api/batches/'),('POST','/api/retry'),('POST','/api/demo'),('GET','/api/documents/missing/pages'),('GET','/api/documents/missing/pages/1/image'),('GET','/api/documents/missing/original'),('GET','/api/review/missing/brief')])
